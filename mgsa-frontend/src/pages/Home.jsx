    ...
    () => [
      {
        ...
        bgAlt: "Students studying with shared resources",
      },
      {
        ...
        bgAlt: "Group of students collaborating",
      },
      {
        title: "Stay Informed",
        ...
        bgAlt: "Students attending an announcement",
      },
      {
        ...
        bgAlt: "Mentor guiding a student",
      },
      {
      ...
      },
      {
        ...
        bgAlt: "Student receiving support",
      },
    ],
    []
  );
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
              ...
              <div className="text-white text-center lg:text-left lg:ml-10">
                ...
                <motion.p
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={prefersReducedMotion ? undefined : { duration: 0.5, ease: "easeInOut", delay: 0.1 }}
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={prefersReducedMotion ? undefined : { duration: 0.5, ease: "easeInOut", delay: 0.2 }}
              ...
              <motion.div
                ...
                transition={prefersReducedMotion ? undefined : { duration: 0.5, ease: "easeInOut", delay: 0.15 }}
        ...
        <div className="relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-10 md:mb-14">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.3 }}
              transition={prefersReducedMotion ? undefined : { duration: 0.5, ease: "easeInOut", delay: 0.05 }}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            transition={prefersReducedMotion ? undefined : { duration: 0.6, ease: "easeInOut", delay: 0.1 }}
