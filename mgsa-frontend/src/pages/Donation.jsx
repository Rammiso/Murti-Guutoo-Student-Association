...
const PaymentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/api/payments/submit`, {
        ...formData,
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#111827] text-white overflow-x-hidden">
      {/* Background Effects */}
